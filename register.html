      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="#" class="sign-in-form">
            ...
            <a href="home.html"><button type="button" class="btn btn-outline-dark btn-lg rounded-5 download-button">Sign in</button></a>
          ...
          <form action="#" class="sign-up-form">
            ...
            <a href="home.html"><button type="button" class="btn btn-outline-dark btn-lg rounded-5 download-button">Sign up</button></a>
